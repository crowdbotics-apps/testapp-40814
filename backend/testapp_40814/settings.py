"""
Django settings for testapp_40814 project.
...
ROOT_URLCONF = 'testapp_40814.urls'
...
WSGI_APPLICATION = 'testapp_40814.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_40814 API",
    "DESCRIPTION": "API documentation for testapp_40814 App",
    "VERSION": "v1",
}
